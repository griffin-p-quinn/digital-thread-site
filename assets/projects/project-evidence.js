(function () {
  ...
  window.PROJECT_EVIDENCE = Object.freeze({
    ...
    'ai-studio-mcp': { files:[['README.md','Documents the installable AI Studio Agent JAR, connection profiles, chat modes, and external MCP hook.'],['docs/jar-file-index.csv','Indexes the unpacked extension contents.']], demo:simulated },
    'ai-studio-millon': { files:[['AIHUB_SCORING_GUIDE.md','Documents score_set deployment, request shape, GBT behavior, empirical error, and local explanations.'],['mainProcessGBT.rmp','Contains the AutoModel training process artifact.']], demo:simulated },
    ...
    'sfdc-v1': { files:[['README.md','Defines the localhost OAuth broker, browser callback, headless path, token persistence, and example routes.']], demo:simulated },
    ...
    '4090': { files:[['README.md','Describes the preserved Jetson Thor model artifact.'],['Jetson_Thor_DevKit_V01_stp.prt / .fac','The repository’s native and faceted NX files.']], demo:simulated },
    ...
    hyperv: { files:[['IEVD/Virtual Machines','Contains the preserved Hyper-V configuration artifacts.'],['IEVD/Snapshots','Contains the snapshot and recovery-state inventory.']], demo:simulated },
    ...
    personal: { files:[['leagueOfGriffins/README.md','Defines the RUNE DIFF UE5 C++ vertical slice, builds, and clause-based combat.']], demo:simulated },
    ...
    racer: { files:[['README.md','Defines Eifel Apex, cars, circuits, controls, checkpoints, laps, and packaged builds.']], demo:simulated },
    ...
    'capital-mcp': { files:[['README.md','Defines dynamic tool generation from the Capital OpenAPI and per-session login/logout.']], demo:simulated },
    ...
    'nx-journals': { files:[['simLaunch.cs','Recorded NXOpen FEM and simulation-setup journal.'],['algodesign.cs','Recorded algorithmic-feature journal.']], demo:simulated },
    ...
    goals: { files:[['goals.md','Contains the private goal, minimum, stretch, and evidence drafting structure.']], demo:simulated },
    luma: { files:[['README.md','Documents the unsupported Luma GraphQL/REST research client and known boundary.']], demo:simulated },
    'ml-dev': { files:[['STATE.md','Defines the AI Studio Agent Builder hardening loop, operator catalog, XML validation, and synthetic fixtures.']], demo:simulated },
    time: { files:[['timetracker.html','Contains the static CSV time-entry dashboard and editor.']], demo:simulated },
    widgets: {
      artifacts:[
    ...
    world: { files:[['CLAUDE.md','Defines the Cesium globe, live entity families, imagery, threats, cameras, and inspection modes.']], demo:simulated },
    ...
    notes: { files:[['README.md','Defines the plaintext work hub, ontology, collections, and knowledge workflow.']], demo:simulated },
    obsidian: { files:[['core-plugins.json','Records enabled core plugins.'],['community-plugins.json','Records community plugin selection.'],['plugins/*/manifest.json','Contains installed plugin metadata.']], demo:simulated },
